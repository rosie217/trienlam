...
function pm_fullwidth_block() {
    if (jQuery('div').hasClass('right_sidebar') || jQuery('div').hasClass('left_sidebar')) {
        ...
        var container = jQuery('.pm_fullwidth_block'), cont_parent_width = jQuery(container).parent().width(),
            site_width = jQuery('body').width(), difference = site_width - cont_parent_width;

        jQuery(container).css({
            'margin-left': '-' + (difference / 2) + 'px', 'width': site_width + 'px'
...
jQuery.fn.gallery_addon_advanced = function (addon_options) {
    "use strict";
    //Set Variables
    var addon_el = jQuery(this), addon_base = this, img_count = addon_options.items.length,
        img_per_load = addon_options.load_count, $newEls = '', loaded_object = '', $container = jQuery('.isotope');
...
jQuery.fn.gallery_listing_addon = function (addon_options) {
    ...
    //Set Variables
    var addon_el = jQuery(this), addon_base = this, img_count = addon_options.items.length,
        img_per_load = addon_options.load_count, $newEls = '', loaded_object = '',
...
jQuery.fn.gallery_listing_title_addon = function (addon_options) {
    ...
    jQuery('.pm_load_more').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_albums_listing_item added" style="width: 25%;"><div class="pm_slbums_listing_wrapper" style="padding-left: 10px; padding-bottom: 10px"><div class="pm_album_thumb_wrapper"><img src="' + addon_options.items[i].src + '" alt=""><div class="pm_album_likes_wrapper"><div class="pm_album_likes_container"><div class="pm_add_like_button"><i class="pm_likes_icon fa fa-heart-o"></i><span class="pm_likes_counter">0</span></div><a class="pm_images_counter_wrapper" href="' + addon_options.items[i].album_href + '"><span class="pm_images_counter_icon"></span><span class="images_counter">' + addon_options.items[i].item_count + '</span></a><div class="clear"></div></div></div></div><div class="pm_album_title">' + addon_options.items[i].title + '</div></div></div>';
            }
...
jQuery.fn.blog_listing_addon = function (addon_options) {
    ...
    //Set Variables
    var addon_el = jQuery(this), addon_base = this, img_count = addon_options.items.length,
        img_per_load = addon_options.load_count, $newEls = '', loaded_object = '', $container = jQuery('.blog_isotope');
    ...
    jQuery('.pm_load_more').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_blog_item added">' + '<div class="pm_blog_item_wrapper">' + '<div class="pm_blog_featured_image_wrapper">' + '<img src="' + addon_options.items[i].src + '" alt="" />' + '<div class="pm_post_likes_wrapper">' + '<div class="pm_image_likes_container">' + '<div class="pm_add_like_button">' + '<i class="pm_likes_icon fa fa-heart-o"></i>' + '<span class="pm_likes_counter">0</span>' + '</div>' + '<a class="pm_potrfolio_read_more" href="' + addon_options.items[i].href + '"></a>' + '<div class="clear"></div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>';
            }
...
jQuery.fn.blog_listing_addon_title = function (addon_options) {
    ...
    jQuery('.pm_load_more').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_blog_item added">' + '<div class="pm_blog_item_wrapper">' + '<div class="pm_blog_featured_image_wrapper">' + '<img src="' + addon_options.items[i].src + '" alt="" />' + '<div class="pm_post_likes_wrapper">' + '<div class="pm_image_likes_container">' + '<div class="pm_add_like_button">' + '<i class="pm_likes_icon fa fa-heart-o"></i>' + '<span class="pm_likes_counter">0</span>' + '</div>' + '<a class="pm_potrfolio_read_more" href="' + addon_options.items[i].href + '"></a>' + '<div class="clear"></div>' + '</div>' + '</div>' + '</div>' + '<div class="pm_blog_post_title">' + addon_options.items[i].title + '</div>' + '</div>' + '</div>';
            }
...
jQuery.fn.portfolio_listing_addon = function (addon_options) {
    ...
    jQuery('.pm_load_more').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_portfolio_item added">' + '<div class="pm_portfolio_item_wrapper">' + '<div class="pm_portfolio_featured_image_wrapper">' + '<img src="' + addon_options.items[i].src + '" alt="" />' + '<div class="pm_post_likes_wrapper">' + '<div class="pm_image_likes_container">' + '<div class="pm_add_like_button">' + '<i class="pm_likes_icon fa fa-heart-o"></i>' + '<span class="pm_likes_counter">0</span>' + '</div>' + '<a class="pm_potrfolio_read_more" href="' + addon_options.items[i].href + '"></a>' + '<div class="clear"></div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>';
            }
...
jQuery.fn.portfolio_listing_addon_title = function (addon_options) {
    ...
    jQuery('.pm_load_more').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_portfolio_item added">' + '<div class="pm_portfolio_item_wrapper">' + '<div class="pm_portfolio_featured_image_wrapper">' + '<img src="' + addon_options.items[i].src + '" alt="" />' + '<div class="pm_post_likes_wrapper">' + '<div class="pm_image_likes_container">' + '<div class="pm_add_like_button">' + '<i class="pm_likes_icon fa fa-heart-o"></i>' + '<span class="pm_likes_counter">0</span>' + '</div>' + '<a class="pm_potrfolio_read_more" href="' + addon_options.items[i].href + '"></a>' + '<div class="clear"></div>' + '</div>' + '</div>' + '</div>' + '<div class="pm_portfolio_post_title">' + addon_options.items[i].title + '</div>' + '</div>' + '</div>';
            }
...
jQuery(document).ready(function () {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
    ...
    // Activate Form Popup
    var popup_container = jQuery(".pm_form_popup_back"), form_wrapper = popup_container.find(".pm_popup_form_wrapper");
    ...
    if (slider_container.length) {
        ...
        slider_container.kenburns({
            images: ['img/clipart/gallery-1920-04.jpg', 'img/clipart/gallery-1920-02.jpg', 'img/clipart/gallery-1920-03.jpg', 'img/clipart/gallery-1920-01.jpg', 'img/clipart/gallery-1920-05.jpg', 'img/clipart/gallery-1920-06.jpg', 'img/clipart/gallery-1920-07.jpg', 'img/clipart/gallery-1920-08.jpg', 'img/clipart/gallery-1920-12.jpg', 'img/clipart/gallery-1920-15.jpg'],
    ...
    var scroll_cont = jQuery('.pm_scroll_container'), desc_scroll_cont = jQuery('.pm_slider_description_cont');
    ...
    var container_height = site_height - header_height, media_height = site_height - 160;
    ...
    jQuery('.advanced_hover_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-4/gallery-1920-04.jpg',
            popup_href: 'img/clipart/gallery-1920-04.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-14.jpg',
            popup_href: 'img/clipart/gallery-1920-14.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-15.jpg',
            popup_href: 'img/clipart/gallery-1920-15.jpg'
        ...
        jQuery('#list').gallery_addon_advanced({
            load_count: 4, items: items_set
        });
    });

    jQuery('.album_grid_margin_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-4/gallery-1920-09.jpg',
            popup_href: 'img/clipart/gallery-1920-09.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-13.jpg',
            popup_href: 'img/clipart/gallery-1920-13.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-14.jpg',
            popup_href: 'img/clipart/gallery-1920-14.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-16.jpg',
            popup_href: 'img/clipart/gallery-1920-16.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-15.jpg',
            popup_href: 'img/clipart/gallery-1920-15.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-19.jpg',
            popup_href: 'img/clipart/gallery-1920-19.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-18.jpg',
            popup_href: 'img/clipart/gallery-1920-18.jpg'
    ...
    jQuery('.album_grid_title_page').each(function () {
        var items_set = [{
            ...
            src: 'img/clipart/grid/col-4/gallery-1920-17.jpg',
            title: 'Autumn Adventures',
            popup_href: 'img/clipart/gallery-1920-17.jpg'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-19.jpg',
            title: 'Dark Mountain',
            popup_href: 'img/clipart/gallery-1920-19.jpg'
            ...
            src: 'img/clipart/grid/col-4/gallery-1920-20.jpg',
            title: 'Golden Gate Bridge',
            popup_href: 'img/clipart/gallery-1920-20.jpg'
        }];
    ...
    jQuery('.album_masonry_page').each(function () {
        var items_set = [{
            src: 'img/clipart/masonry/col-4/masonry-06.jpg',
            popup_href: 'img/clipart/masonry/masonry-06.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-16.jpg',
            popup_href: 'img/clipart/masonry/masonry-16.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-09.jpg',
            popup_href: 'img/clipart/masonry/masonry-09.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-10.jpg',
            popup_href: 'img/clipart/masonry/masonry-10.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-11.jpg',
            popup_href: 'img/clipart/masonry/masonry-11.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-13.jpg',
            popup_href: 'img/clipart/masonry/masonry-13.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-12.jpg',
            popup_href: 'img/clipart/masonry/masonry-12.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-14.jpg',
            popup_href: 'img/clipart/masonry/masonry-14.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-22.jpg',
            popup_href: 'img/clipart/masonry/masonry-22.jpg'
        }, {
            src: 'img/clipart/masonry/col-4/masonry-21.jpg',
            popup_href: 'img/clipart/masonry/masonry-21.jpg'
    ...
    jQuery('.albums_listing_grid_title_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/thumbs/thumb-13.jpg',
            album_href: 'album-grid.html',
            title: 'Grid Gallery',
            item_count: '20'
        }, {
            src: 'img/clipart/grid/thumbs/thumb-14.jpg',
            album_href: 'album-scattered.html',
            title: 'Scattered Gallery',
            item_count: '48'
        }];
    ...
    jQuery('.blog_grid_2_page').each(function () {
        var items_set = [{
            src: 'img/clipart/blog/col-2/blog11.jpg',
            href: 'blog-post-video-full.html'
        }, {
            src: 'img/clipart/blog/col-2/blog03.jpg',
            href: 'blog-post-standard.html'
        }, {
            src: 'img/clipart/blog/col-2/blog14.jpg',
            href: 'blog-post-image-full.html'
        }, {
            src: 'img/clipart/blog/col-2/blog06.jpg',
            href: 'blog-post-video-full.html'
        }, {
            src: 'img/clipart/blog/col-2/blog10.jpg',
            href: 'blog-post-standard.html'
        }, {
            src: 'img/clipart/blog/col-2/blog02.jpg',
            href: 'blog-post-image-full.html'
        }, {
            src: 'img/clipart/blog/col-2/post10.jpg',
            href: 'blog-post-video-full.html'
    ...
    jQuery('.blog_grid_3_page').each(function () {
        var items_set = [{
            src: 'img/clipart/blog/col-3/blog03.jpg',
            href: 'blog-post-standard.html'
        }, {
            src: 'img/clipart/blog/col-3/blog14.jpg',
            href: 'blog-post-image-full.html'
        }, {
            src: 'img/clipart/blog/col-3/blog06.jpg',
            href: 'blog-post-video-full.html'
        }, {
            src: 'img/clipart/blog/col-3/blog10.jpg',
            href: 'blog-post-standard.html'
        }, {
            src: 'img/clipart/blog/col-3/blog02.jpg',
            href: 'blog-post-image-full.html'
        }, {
            src: 'img/clipart/blog/col-3/post10.jpg',
            href: 'blog-post-video-full.html'
        }, {src: 'img/clipart/blog/col-3/blog05.jpg', href: 'blog-post-standard.html'}];

        jQuery('#list').blog_listing_addon({
            load_count: 3, items: items_set
        });
    });

    jQuery('.blog_grid_4_page').each(function () {
        var items_set = [{
            src: 'img/clipart/blog/col-4/blog10.jpg',
            href: 'blog-post-standard.html'
        }, {
            src: 'img/clipart/blog/col-4/blog02.jpg',
            href: 'blog-post-image-full.html'
        }, {
            src: 'img/clipart/blog/col-4/post10.jpg',
            href: 'blog-post-video-full.html'
    ...
    jQuery('.blog_grid_5_page').each(function () {
        var items_set = [{src: 'img/clipart/blog/col-5/blog05.jpg', href: 'blog-post-standard.html'}];

        jQuery('#list').blog_listing_addon({
            load_count: 5, items: items_set
        });
    });
    ...
    jQuery('.blog_masonry_margin_page').each(function () {
        var items_set = [{
            src: 'img/clipart/blog/blog10.jpg',
            href: 'blog-post-standard.html'
        }, {src: 'img/clipart/blog/blog02.jpg', href: 'blog-post-image-full.html'}, {
            src: 'img/clipart/blog/post10.jpg',
            href: 'blog-post-video-full.html'
    ...
    jQuery('.blog_masonry_title_page').each(function () {
        var items_set = [{
            ...
            src: 'img/clipart/blog/blog02.jpg',
            href: 'blog-post-image-full.html',
            title: 'Stephany '
        }, {
            src: 'img/clipart/blog/post10.jpg',
    ...
    jQuery('.portfolio_grid_2_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-2/gallery-1920-25.jpg',
            href: 'porfolio-post-video-full.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-12.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-09.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-23.jpg',
            href: 'porfolio-post-video-full.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-05.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-07.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-2/gallery-1920-17.jpg',
            href: 'porfolio-post-video-full.html'
    ...
    jQuery('.portfolio_grid_3_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-3/gallery-1920-12.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-3/gallery-1920-09.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-3/gallery-1920-23.jpg',
            href: 'porfolio-post-video-full.html'
        }, {
            src: 'img/clipart/grid/col-3/gallery-1920-05.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-3/gallery-1920-07.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-3/gallery-1920-17.jpg',
            href: 'porfolio-post-video-full.html'
    ...
    jQuery('.portfolio_grid_4_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-4/gallery-1920-05.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-07.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-4/gallery-1920-17.jpg',
            href: 'porfolio-post-video-full.html'
    ...
    jQuery('.portfolio_grid_5_page').each(function () {
        var items_set = [{src: 'img/clipart/grid/col-5/gallery-1920-08.jpg', href: 'porfolio-post-standard.html'}];
    ...
    jQuery('.portfolio_grid_title_page').each(function () {
        var items_set = [{
            ...
            src: 'img/clipart/grid/col-4/gallery-1920-08.jpg',
            href: 'porfolio-post-standard.html',
            title: 'Green Forest'
        }];
    ...
    jQuery('.portfolio_masonry_margin_page').each(function () {
        var items_set = [{
            src: 'img/clipart/grid/col-4/featured05.jpg',
            href: 'porfolio-post-standard.html'
        }, {
            src: 'img/clipart/grid/col-4/featured07.jpg',
            href: 'porfolio-post-image-full.html'
        }, {
            src: 'img/clipart/grid/col-4/featured16.jpg',
            href: 'porfolio-post-video-full.html'
    ...
    jQuery('.portfolio_masonry_title_page').each(function () {
        var items_set = [{
            ...
            href: 'porfolio-post-standard.html',
            title: 'Forests'
        }, {src: 'img/clipart/grid/col-4/featured07.jpg', href: 'porfolio-post-image-full.html', title: 'Đ¡rows'}, {
            src: 'img/clipart/grid/col-4/featured16.jpg',
            href: 'porfolio-post-video-full.html',
            title: 'Autumn Mountains'
    ...
    jQuery('.album_scattered_page').each(function () {
        ...
        var items_set = [{
            src: 'img/clipart/scattered/gallery-1920-15.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_1',
            popup_href: 'img/clipart/gallery-1920-15.jpg',
            title: 'Pines'
        }, {
            src: 'img/clipart/scattered/gallery-1920-04.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_2',
            popup_href: 'img/clipart/gallery-1920-04.jpg',
            title: 'Mount Everest'
        }, {
            src: 'img/clipart/scattered/gallery-1920-17.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_3',
            popup_href: 'img/clipart/gallery-1920-17.jpg',
            title: 'Autumn Adventures'
        }, {
            src: 'img/clipart/scattered/gallery-1920-18.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_4',
            popup_href: 'img/clipart/gallery-1920-18.jpg',
            title: 'Pier'
        }, {
            src: 'img/clipart/scattered/gallery-1920-44.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_5',
            popup_href: 'img/clipart/gallery-1920-44.jpg',
            title: 'Zenit'
        }, {
            src: 'img/clipart/scattered/gallery-1920-19.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_6',
            popup_href: 'img/clipart/gallery-1920-19.jpg',
            title: 'Dark Mountain'
        }, {
            src: 'img/clipart/scattered/gallery-1920-20.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_7',
            popup_href: 'img/clipart/gallery-1920-20.jpg',
            title: 'Golden Gate Bridge'
        }, {
            src: 'img/clipart/scattered/gallery-1920-21.jpg',
            layer_num: 'layer_3',
            photo_num: 'photo_8',
            popup_href: 'img/clipart/gallery-1920-21.jpg',
            title: 'Long Way Home'
        }, {
            src: 'img/clipart/scattered/gallery-1920-22.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_1',
            popup_href: 'img/clipart/gallery-1920-22.jpg',
            title: 'Carpathian Mountains'
        }, {
            src: 'img/clipart/scattered/gallery-1920-23.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_2',
            popup_href: 'img/clipart/gallery-1920-23.jpg',
            title: 'Pines'
        }, {
            src: 'img/clipart/scattered/gallery-1920-33.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_3',
            popup_href: 'img/clipart/gallery-1920-33.jpg',
            title: 'Clouds'
        }, {
            src: 'img/clipart/scattered/gallery-1920-32.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_4',
            popup_href: 'img/clipart/gallery-1920-32.jpg',
            title: 'Sunset'
        }, {
            src: 'img/clipart/scattered/gallery-1920-31.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_5',
            popup_href: 'img/clipart/gallery-1920-31.jpg',
            title: 'Snowy Pines'
        }, {
            src: 'img/clipart/scattered/gallery-1920-30.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_6',
            popup_href: 'img/clipart/gallery-1920-30.jpg',
            title: 'Shore'
        }, {
            src: 'img/clipart/scattered/gallery-1920-28.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_7',
            popup_href: 'img/clipart/gallery-1920-28.jpg',
            title: 'Summer Trip'
        }, {
            src: 'img/clipart/scattered/gallery-1920-27.jpg',
            layer_num: 'layer_4',
            photo_num: 'photo_8',
            popup_href: 'img/clipart/gallery-1920-27.jpg',
            title: 'Mountains and Sea'
        }, {
            src: 'img/clipart/scattered/gallery-1920-26.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_1',
            popup_href: 'img/clipart/gallery-1920-26.jpg',
            title: 'Ocean'
        }, {
            src: 'img/clipart/scattered/gallery-1920-25.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_2',
            popup_href: 'img/clipart/gallery-1920-25.jpg',
            title: 'The Road'
        }, {
            src: 'img/clipart/scattered/gallery-1920-24.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_3',
            popup_href: 'img/clipart/gallery-1920-24.jpg',
            title: 'Adventures'
        }, {
            src: 'img/clipart/scattered/gallery-1920-34.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_4',
            popup_href: 'img/clipart/gallery-1920-34.jpg',
            title: 'Vanilla Sky'
        }, {
            src: 'img/clipart/scattered/gallery-1920-35.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_5',
            popup_href: 'img/clipart/gallery-1920-35.jpg',
            title: 'Rainy Day'
        }, {
            src: 'img/clipart/scattered/gallery-1920-36.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_6',
            popup_href: 'img/clipart/gallery-1920-36.jpg',
            title: 'Green Forest'
        }, {
            src: 'img/clipart/scattered/gallery-1920-37.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_7',
            popup_href: 'img/clipart/gallery-1920-37.jpg',
            title: 'Pines'
        }, {
            src: 'img/clipart/scattered/gallery-1920-38.jpg',
            layer_num: 'layer_1',
            photo_num: 'photo_8',
            popup_href: 'img/clipart/gallery-1920-38.jpg',
            title: 'Foggy Forest'
        }, {
            src: 'img/clipart/scattered/gallery-1920-39.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_1',
            popup_href: 'img/clipart/gallery-1920-39.jpg',
            title: 'The Last Autumn Trip'
        }, {
            src: 'img/clipart/scattered/gallery-1920-40.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_2',
            popup_href: 'img/clipart/gallery-1920-40.jpg',
            title: 'Golden Shore'
        }, {
            src: 'img/clipart/scattered/gallery-1920-41.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_3',
            popup_href: 'img/clipart/gallery-1920-41.jpg',
            title: 'Blue Ocean'
        }, {
            src: 'img/clipart/scattered/gallery-1920-42.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_4',
            popup_href: 'img/clipart/gallery-1920-42.jpg',
            title: 'Big Mount'
        }, {
            src: 'img/clipart/scattered/gallery-1920-43.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_5',
            popup_href: 'img/clipart/gallery-1920-43.jpg',
            title: 'Stones'
        }, {
            src: 'img/clipart/scattered/gallery-1920-46.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_6',
            popup_href: 'img/clipart/gallery-1920-46.jpg',
            title: 'Grasses'
        }, {
            src: 'img/clipart/scattered/gallery-1920-48.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_7',
            popup_href: 'img/clipart/gallery-1920-48.jpg',
            title: 'Autumn Field'
        }, {
            src: 'img/clipart/scattered/gallery-1920-45.jpg',
            layer_num: 'layer_2',
            photo_num: 'photo_8',
            popup_href: 'img/clipart/gallery-1920-45.jpg',
            title: 'Seagulls'
        }];

        jQuery('#list').gallery_scattered_addon({
            load_count: 8, items: items_set
        });
    });
...
jQuery(window).load(function () {
    ...
    jQuery('.album_waterwheel_page').each(function () {
        ...
        if (site_width > 737) {
            ...
            /* Autoplay */
            var autoplay_status = 'on', slide_duration = '5000', intervalID;
    ...
    jQuery('.album_stripes_page').each(function () {
        var slider_height = site_height - header_height - 107, slider_width = jQuery('.pm_stripes_wrapper').width(),
            margin_size = 10, items_per_page = 6, item_with = (slider_width + margin_size) / items_per_page;
    ...
    jQuery('.album_portrait_page').each(function () {
        var slider_height = site_height - header_height - 80, slider_container = jQuery('.pm_gallery_container');
    ...
    jQuery('.albums_listing_tape_page').each(function () {
        var next_button = jQuery(this).find('.pm_next_slide_button'),
            prev_button = jQuery(this).find('.pm_prev_slide_button'), pm_index = 107;
    ...
    jQuery('.page404').each(function () {
        var container_height = site_height - header_height - 107, wrapper = jQuery('.pm_404_content_wrapper'),
...
jQuery(window).resize(function () {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('.pm_header').height(), media_height = site_height - header_height - 80;
...
function post_image_slider() {
    var slider_container = jQuery('.pm_media_outout_image_listing'), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length, slide_item = jQuery('.pm_media_outout_image_listing li'), intervalID,
        next_button = jQuery('.pm_media_output_cont_wrapper .pm_next_slide_button'),
        prev_button = jQuery('.pm_media_output_cont_wrapper .pm_prev_slide_button'), current_item, slide_number;
...
function post_image_next_slide() {
    var slider_container = jQuery('.pm_media_outout_image_listing'), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length, slide_item = jQuery('.pm_media_outout_image_listing li'),
        current_item = jQuery('.pm_media_outout_image_listing li.visible_slide'),
    ...
    var current_item_new = slider_container.find('.visible_slide'),
        slide_number_new = current_item_new.attr('data-number'), next_thumb_back, prev_thumb_back;
...
function slide_carousel() {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        sliderList = jQuery('.pm_gallery.effect_slide'), slide_item = jQuery(sliderList).find('li');

    slide_item.width(site_width - 80);

    var increment = jQuery(sliderList).children().outerWidth(true), elmnts = jQuery(sliderList).children(),
        numElmts = elmnts.length, sizeFirstElmnt = increment,
        shownInViewport = Math.round(jQuery(window).width() / sizeFirstElmnt), firstElementOnViewPort = 1,
        isAnimating = false, next_button = jQuery('.pm_next_slide_button'),
        prev_button = jQuery('.pm_prev_slide_button'), i;
...
function slide_carousel_next_slide(isAnimating, firstElementOnViewPort, numElmts, sliderList, increment) {
    var slider_container = jQuery('.pm_gallery.effect_slide'), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length - 1, slide_item = jQuery('.pm_gallery.effect_slide li'),
        current_item = jQuery('.pm_gallery.effect_slide li.visible_slide'),
        slide_number = current_item.attr('data-number'), next_button = jQuery('.pm_next_slide_button'),
...
function slider_fade() {
    var slider_container = jQuery('.pm_gallery.effect_fade'), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length, slide_item = jQuery('.pm_gallery.effect_fade li'), intervalID,
        next_button = jQuery('.pm_next_slide_button'), prev_button = jQuery('.pm_prev_slide_button'),
        autuplay_status = 'on', slide_duration = 5000;
    ...
    function next_slide() {
        var slider_container = jQuery('.pm_gallery.effect_fade'), elements = jQuery(slider_container).children(),
            number_of_elements = elements.length, slide_item = jQuery('.pm_gallery.effect_fade li'),
...
jQuery.fn.gallery_scattered_addon = function (addon_options) {
    ...
    jQuery('.pm_more_scattered_photos').on('click', function () {
        ...
        if (now_load > 0) {
            // load more elements
            for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                loaded_object = loaded_object + '<div class="pm_scattered_' + addon_options.items[i].layer_num + ' added">' + '<div class="pm_scattered_photo ' + addon_options.items[i].photo_num + ' invisible">' + '<div class="pm_scattered_image">' + '<a href="' + addon_options.items[i].popup_href + '">' + '<img src="' + addon_options.items[i].src + '" alt="" />' + '</a>' + '</div>' + '<div class="pm_scattered_description">' + '<div class="pm_scattered_title pm_fleft">' + addon_options.items[i].title + '</div>' + '<div class="pm_scattered_likes pm_fright">' + '<div class="pm_add_like_button">' + '<i class="pm_likes_icon fa fa-heart-o"></i>' + '<span class="pm_likes_counter">0</span>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>';
            }
...
function carousel_waterWheel() {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('header').height(), slider_height = site_height - header_height - 80,
        slider_container = jQuery('.pm_gallery_container'), waterWheel = jQuery(slider_container).find('.pm_gallery'),
        elements = jQuery(waterWheel).children(), number_of_elements = elements.length;
    ...
    if (site_width > 1025) {
        waterWheel.height(slider_height * 0.676).css({
            'margin-top': slider_height * 0.084, 'margin-bottom': slider_height * .24
        });
    } else {
        waterWheel.height(slider_height * 0.79).css({
            'margin-top': slider_height * 0.084, 'margin-bottom': slider_height * .084
        });
    }
...
function position_waterWheel() {
    var current_item = jQuery('.current_item'), current_item_width = current_item.find('img').width(),
        prev_item = jQuery('.prev_item'), next_item = jQuery('.next_item'), prev_item_2 = jQuery('.prev_item_2'),
        next_item_2 = jQuery('.next_item_2'), cur_offset = current_item_width / 2,
    ...
    var next_thumb_back = next_item.attr('data-thumbnail'), prev_thumb_back = prev_item.attr('data-thumbnail'),
        next_button = jQuery('.pm_next_slide_button'), prev_button = jQuery('.pm_prev_slide_button');
...
function ww_next_slide() {
    var slider_container = jQuery('.pm_gallery_container'), waterWheel = jQuery(slider_container).find('.pm_gallery'),
        elements = jQuery(waterWheel).children(), number_of_elements = elements.length,
        gallery_item = waterWheel.find('.pm_gallery_item'), current_item = waterWheel.find('.current_item'),
        prev_item = waterWheel.find('.prev_item'), next_item = waterWheel.find('.next_item'),
        prev_item_2 = waterWheel.find('.prev_item_2'), next_item_2 = waterWheel.find('.next_item_2'),
        cur_item_number = current_item.attr('data-number'), likes_container = jQuery('.pm_slide_likes_wrapper'),
        slide_likes = likes_container.find('.pm_add_like_button').detach();
...
function carousel_tape() {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('header').height(), slider_height = site_height - header_height - 107,
        slider_container = jQuery('.pm_gallery_container'), slider_list = jQuery(slider_container).find('.pm_gallery'),
        elements = jQuery(slider_list).children(), number_of_elements = elements.length,
        gallery_item = slider_list.find('.pm_gallery_item');

    slider_container.height(slider_height).css('margin-top', header_height);
    slider_list.height(slider_height * 0.91).css({
        'margin-top': slider_height * 0.044, 'margin-bottom': slider_height * 0.044
    });
...
function tape_position() {
    var current_item = jQuery('.current_item'), current_item_width = current_item.find('img').width(),
        ...
        prev_2_offset = prev_offset + (prev_item_2.find('img').width()) + 10, next_offset = cur_offset + 10,
...
function tape_next_slide() {
    var slider_container = jQuery('.pm_gallery_container'), slider_list = jQuery(slider_container).find('.pm_gallery'),
        elements = jQuery(slider_list).children(), number_of_elements = elements.length,
        gallery_item = slider_list.find('.pm_gallery_item'), current_item = slider_list.find('.current_item'),
        prev_item = slider_list.find('.prev_item'), next_item = slider_list.find('.next_item'),
        prev_item_2 = slider_list.find('.prev_item_2'), next_item_2 = slider_list.find('.next_item_2'),
        cur_item_number = current_item.attr('data-number'), likes_container = jQuery('.pm_slide_likes_wrapper'),
        slide_likes = likes_container.find('.pm_add_like_button').detach();
...
function pm_stripe_carousel() {
    var site_width = jQuery(window).width(), slider_list = jQuery('.pm_gallery'),
        increment = slider_list.find('li.pm_gallery_item').width(), elements = jQuery(slider_list).children(),
        number_elements = elements.length, elements_in_window = Math.round(jQuery(this).width() / increment),
        first_element_in_window = 1, isAnimating = false, i;
    ...
    // Thumbnails
    var stripe_item = jQuery('.pm_gallery_item'), first_item = stripe_item.first(),
        last_item = jQuery(slider_list).find('#item_6'), first_item_num = jQuery(first_item).attr('data-number'),
        last_item_num = jQuery(last_item).attr('data-number'), prev_thumb_back, next_thumb_back,
        all_slides = stripe_item.length, next_button = jQuery('.pm_next_slide_button'),
        prev_button = jQuery('.pm_prev_slide_button');
    ...
    function stripe_next_slide() {
        ...
        // Next Thumbnail
        var stripe_container = jQuery('.pm_gallery'), stripe_item = jQuery(stripe_container).find('.pm_gallery_item'),
            ...
            last_item_num = jQuery(last_item).attr('data-number'), all_slides = stripe_item.length,
            next_button = jQuery('.pm_next_slide_button'), prev_button = jQuery('.pm_prev_slide_button'),
            new_first_item, new_last_item, prev_thumb_back, next_thumb_back;
...
function slider_fade_video() {
    var slider_container = jQuery('.pm_gallery.effect_fade'), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length, slide_item = jQuery('.pm_gallery.effect_fade li'), intervalID,
        next_button = jQuery('.pm_next_slide_button'), prev_button = jQuery('.pm_prev_slide_button'),
        site_width = jQuery(window).width(), site_height = jQuery(window).height();
    ...
    if (site_width > 1024) {
        if (((site_height + 150) / 9) * 16 > site_width) {
            var player_width = ((site_height + 150) / 9) * 16, player_height = site_height + 150;
            ...
            video_player.css({
                'margin-left': -1 * (player_width / 2) + 'px',
                'margin-top': -1 * (player_height / 2) + 'px',
                'top': '50%',
                'left': '0'
            });
        }
...
function listing_carousel_tape() {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('header').height(), slider_container = jQuery('.pm_albums_tape_container'),
        slider_list = jQuery(slider_container).find('.pm_gallery'), elements = jQuery(slider_list).children(),
        number_of_elements = elements.length, gallery_item = slider_list.find('.pm_gallery_item'),
...
function listing_tape_resize(i) {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('header').height(), slider_height = site_height - header_height - i,
...
function listing_tape_next_slide() {
    var slider_container = jQuery('.pm_albums_tape_container'),
        slider_list = jQuery(slider_container).find('.pm_gallery'), elements = jQuery(slider_list).children(),
        number_of_elements = elements.length, gallery_item = slider_list.find('.pm_gallery_item'),
        current_item = slider_list.find('.current_item'), prev_item = slider_list.find('.prev_item'),
        next_item = slider_list.find('.next_item'), prev_item_2 = slider_list.find('.prev_item_2'),
        next_item_2 = slider_list.find('.next_item_2'), cur_item_number = current_item.attr('data-number'),
...
function listing_post_format_image_slider(i) {
    var listing_id = '#' + i, slider_container = jQuery(listing_id), elements = jQuery(slider_container).children(),
        number_of_elements = elements.length, slide_item = jQuery(slider_container).find('li'), intervalID,
...
function blog_listing_tape_resize(i) {
    var site_width = jQuery(window).width(), site_height = jQuery(window).height(),
        header_height = jQuery('header').height(), slider_height = site_height - header_height - i,
        slider_container = jQuery('.pm_blog_listing_tape_container'),
        slider_list = jQuery(slider_container).find('.pm_gallery'), gallery_item = slider_list.find('.pm_gallery_item'),
        gallery_image_width = jQuery(gallery_item).find('img').width();
...
function blog_listing_tape_next_slide() {
    var slider_container = jQuery('.pm_blog_listing_tape_container'),
        ...
        next_item_2 = slider_list.find('.next_item_2'), cur_item_number = current_item.attr('data-number'),
        likes_container = jQuery('.pm_slide_likes_wrapper'),
        slide_likes = likes_container.find('.pm_add_like_button').detach(), comments_link, slide_comments;
